  ...
  --scrollView.width = 900
	        ...
	        elseif( self.isFocus ) then
	                ...
	                if( phase == "moved" ) then
					       local bottomLimit = screenH - self.height - self.bottom
								 --local bottomLimit = screenH - self.bottom
	...
	function trackVelocity(event)
		...
		if scrollView.prevY then
			local Y = scrollView.y
			scrollView.velocity = (Y- scrollView.prevY)/timePassed
		end
